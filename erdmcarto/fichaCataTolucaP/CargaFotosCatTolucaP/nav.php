...
<br> 
 <nav class="navbar navbar-expand-lg navbar-light">
   <a href="acceso.php"><img src="logoFIDI.png" width="150" height="110" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <?php if(isset($_SESSION['tipousuario'])){ ?>    
        <a class="nav-item nav-link" href="../../../../cartomaps/erdmcarto/php/config.php">| <i class="fas fa-users-cog"></i> Administrador |</a>
    <?php } ?>    
...
<!--        <a class="nav-item nav-link" href="acceso.php">| <i class="fas fa-drafting-compass"></i> MapERDM |</a>-->
    <?php if((isset($_SESSION['fichas'])) and ($_SESSION['fichas'] == 3) or (isset($_SESSION['tipousuario']))){ ?>
        <a class="nav-item nav-link" href="../../../../cartomaps/erdmcarto/php/accesDoctos.php">| <i class="far fa-file-alt"></i> Documentos |</a>
    <?php } ?>
<!--        <a class="nav-item nav-link" href="#">| Cargar Base |</a>-->
        <a class="nav-item nav-link" href="../../../../cartomaps/erdmcarto/php/logout.php">| Salir <i class="fas fa-sign-out-alt"></i>|</a>
<!--

...
if(isset($_GET['cuentaFicha'])){
    //$Acue="select * from nuevaCActuales";///**********?????????????????????????????????????????????????????**************** A modificar
    $Acue="select * from insertCuentasActuales where cuentaPredial = ".$_GET['cuentaFicha'];///**********?????????????????????????????????????????????????????**************** A modificar
    $Acuenta=sqlsrv_query($cnx,$Acue);
    $AcuentasActuales=sqlsrv_fetch_array($Acuenta);

}

if($AcuentasActuales != null and $AcuentasActuales != false){
...
//**************************************************************************
    $con="select * from insertTipologias
    where CLAVES=$cuenta";     ///*????????????????????????????????????????????????????********************** A modificar
...
//**************************************************************************
    ...
    $Ava18="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
    $Avalores18=sqlsrv_query($cnx,$Ava18);
    $Avalores2018=sqlsrv_fetch_array($Avalores18);

//**************************************************************************

    $Ava19="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $Ava20="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $Ava21="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $Ava22="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    $Ava23="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $va18="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $va19="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $va20="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $va21="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $va22="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    $va23="select * from insertTipologias
    inner join tablasValor on insertTipologias.CCC=tablasValor.CCC
    where insertTipologias.CLAVES=$cuenta";
...
//**************************************************************************
    ...
    $fichasQuery="select insertTipologias.CLAVES,insertTipologias.CCC,insertTipologias.AREA,insertTipologias.NIVEL,padron.Cuenta_predial,
    ...
    insertCuentasActuales.cuentaPredial,insertCuentasActuales.CURT,insertCuentasActuales.Clave,
    insertCuentasActuales.Frente,insertCuentasActuales.Factor as factorCuentas,insertCuentasActuales.Fondo,insertCuentasActuales.Factor1 as factorUno,
    insertCuentasActuales.Posicion as posicionCuentas,insertCuentasActuales.Factor2 as factorDos,insertCuentasActuales.Valorm2_17_18,insertCuentasActuales.Valorm2_19,
    insertCuentasActuales.Valorm2_20_22,insertCuentasActuales.Valorm2_23,insertCuentasActuales.ValorAV,insertCuentasActuales.ValorAV_17_18,insertCuentasActuales.ValorAV_19,insertCuentasActuales.ValorAV_20_22,
    insertCuentasActuales.UsodeSuelo,insertCuentasActuales.Observaciones as observacionesCuentas,insertCuentasActuales.estadoEdificacion,insertCuentasActuales.Topografia,insertCuentasActuales.factorTopografia,
    insertCuentasActuales.tipodeServicio_Actual,insertCuentasActuales.giro_Actual,
    ...
    from insertTipologias
    inner join PadronCataZapopan2023 as padron on padron.Cuenta_predial=insertTipologias.CLAVES
    inner join insertCuentasActuales on insertCuentasActuales.cuentaPredial=padron.Cuenta_predial
    inner join tablasValor on tablasValor.CCC=insertTipologias.CCC
    where insertTipologias.CLAVES=$cuenta";
...
if(isset($_GET['anioIni'])){
    if($_GET['anioIni'] == '18b'){
        echo '<script type="text/javascript">window.open("fichaCatastralExecute2023.php?clvCL='.$tokenResult.'&crt='.$CURT.'&anio=18b'.'");</script>';
    } else if($_GET['anioIni'] == '17b' or $_GET['anioIni'] == '17a'){
        echo '<script type="text/javascript">window.open("fichaCatastralExecute17_23.php?clvCL='.$tokenResult.'&crt='.$CURT.'&anio='.$_GET['anioIni'].'");</script>';
    }
} else{
...
echo 'Finalizado';
//header('location:registroFicha.php');
//echo '<meta http-equiv="refresh" content="0,url=registroFicha.php"';
echo '<script> window.location.replace("registroFicha.php"); </script>"';

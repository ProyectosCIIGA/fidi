...
<body>
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <h5 style="text-shadow: 1px 1px 2px #717171;text-align:center;">Plaza: <?php echo utf8_encode(ucwords(strtolower($mapaNL['nombreplaza']))) ?></h5>
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="map.php?plz=<?php echo $_GET['plz'] ?>"><i class="fas fa-map-marked-alt"></i> Mapas <?php echo utf8_encode(ucwords(strtolower($mapaNL['nombreplaza']))) ?></a><br>
                </div>
            </div>

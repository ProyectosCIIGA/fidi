...
$pdf->SetFont('Arial','',8);
$pdf->Cell(196,4,utf8_decode(trim($empleado['NPropietario'])),1,1,'C');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(196,4,utf8_decode(trim($empleado['RSocial'])),1,1,'C');
...
$pdf->SetFont('Arial','',7);
$pdf->Cell(60,4,utf8_decode(trim($empleado['Calle'])),1,0,'C');
$pdf->Cell(23,4,utf8_decode(trim($empleado['NumExterior'])),1,0,'C');
$pdf->Cell(23,4,utf8_decode(trim($empleado['NumInterior'])),1,0,'C');
$pdf->Cell(60,4,utf8_decode(trim($empleado['Colonia'])),1,0,'C');
$pdf->Cell(30,4,utf8_decode(trim($empleado['CP'])),1,1,'C');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(98,4,utf8_decode(trim($empleado['TServicio'])),1,0,'C');
$pdf->Cell(98,4,utf8_decode(trim($empleado['Giro'])),1,1,'C');
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(98,4,utf8_decode(trim($empleado['tipoServicioA'])),1,0,'C');
$pdf->Cell(98,4,utf8_decode(trim($empleado['giroA'])),1,1,'C');
